...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Anime Short Video By Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Funny Video by Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Tiktok FYP video by Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Meme ID by Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Mentahan PP couple by Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
...
async def _(event):
    ...
    try:
        ...
        await tbot.send_file(
            event.chat.id, 
            caption="Negative Content By Hiroshirobot", 
            file=pantek
            )
        await memeks.delete()
    except Exception:
